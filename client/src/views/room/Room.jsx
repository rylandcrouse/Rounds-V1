    ...
    return (
        <Container>
            <Options>
                ...
                <SideOpts>
                    <LeaveBtn onClick={() => handleStart()}>
                        Play
                        {/* <PlayButton xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-controller" viewBox="0 0 16 16">
