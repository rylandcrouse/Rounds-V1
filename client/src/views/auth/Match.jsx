    ...
    return (
        <Container>
                <Groupet controlId="formBasicCode">
                    <svg style={{'margin': '1em'}} xmlns="http://www.w3.org/2000/svg" width="2.8em" height="2.8em" fill="currentColor" className="bi bi-shield-lock" viewBox="0 0 16 16">
            ...
            <Formy onKeyPress={e => handleEnter(e)}>
                ...
                <Memo>
                    Email sent to {store.auth.matchEmail && <span>{store.auth.matchEmail}</span>}.
                </Memo>
