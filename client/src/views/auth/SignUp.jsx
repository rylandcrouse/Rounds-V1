    ...
    return (
        <Container>
            ...
            <Formy onKeyPress={e => handleEnter(e)}>
                <Inpoots controlId="formBasicUsername">
                    <Formy.Label>Display Name</Formy.Label>
                    <Formy.Control name='display_name' value={form.display_name} onChange={e => setForm(e)} type="text" placeholder="Enter display name" />
                ...
                <Inpoots controlId="formBasicPassword">
                    <Formy.Label>Password Confirmation</Formy.Label>
                    <Formy.Control name='password_confirmation' value={form.password_confirmation} onChange={e => setForm(e)} type="password" placeholder="Password" />
                </Inpoots>
                <Groupet>
